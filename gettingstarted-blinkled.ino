...
char mqttPass[] = "OPQD85G49L0F210D";        // Change this to your MQTT API key from Account > MyProfile.
char writeAPIKey[] = "AUBGCY7X7ZD7NC74";     // Change this to your channel write API key.
long channelID = 1358859;                     // Change this to your channel number.
